...
the configuration and syntax of CET are different from that of TT.
Note: items that are planned to work in TT3 are marked with (TT3).
...
=item Virtual Object Namespaces. (TT3)
