...
function eob_get_val (key, extra2, extra1, default) {
...
function eob_as_string (extra2) {
  ...
  var joiner = eob_get_val('as_string_join',   extra2, extra1, '<br />');
...
function eob_get_error_text (err) {
  ...
  for (var i = 0; i < possible_keys.length; i ++) {
    ...
    var ret = (field_val[key]) ? field_val[key] : (extra[key]) ? extra[key] : continue;
